...
public class Product {
    ...
    public String getCopyIn() {
        return copyIn;
    }

    public void setCopyIn(String copyIn) {
        this.copyIn = copyIn;
    }
    ...
    public String getAddedFilters() {
        return addedFilters;
    }

    public void setAddedFilters(String addedFilters) {
